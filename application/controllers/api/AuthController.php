        ...
        if($verifyTokenResult[self::RESULT_FIELD_NAME]) {
			...
			$content ='
					...
					<body style="padding:0; margin:0">
						<span style="height: 0; width: 0; line-height: 0pt; opacity: 0; display: none;">
							This is where you write what it\'ll show on the clients email listing. If not, it\'ll take the first text of the email.</span>
										...
										<tr>
											<td>
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														<td style="background-image:url('.base_url().'assets/email/welcome/background.jpg); padding: 0 50px 50px" bgcolor="#ABC1DE" valign="top" align="center" class="content">
															<!--[if gte mso 9]>
																...
																<table width="100%" border="0" cellspacing="0" cellpadding="0">
																	<tr>
																		<td align="center" style="padding: 53px 20px 40px">
																			<a href="#" target="_blank"><img src="'.base_url().'assets/email/logo.png" width="153" height="47" border="0" alt="" /></a>
																		</td>
																	</tr>
																</table>
																		...
																		<td valign="bottom" >
																			<table width="100%" border="0" cellspacing="0" cellpadding="0">
																				<tr>
																					...
																					<td width="98" height="98" bgcolor="#F8F8F8" style="border-radius: 50% 50% 0 0!important;max-height: 98px !important;"><img src="'.base_url().'assets/email/welcome/icon.png" width="98" height="98" border="0" alt="" style="border: 0 !important; outline:none; text-decoration: none;display:block;max-height: 98px !important;" /></td>
																					<td height="98">
																			...
																			<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#ffffff">
																				<tr>
																					<td bgcolor="#F8F8F8">
																						<table width="100%" border="0" cellspacing="0" cellpadding="0">
																							<tr>
																								<td bgcolor="#ffffff" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#F8F8F8"><tr><td bgcolor="#F8F8F8" height="25" style="font-size:0pt; line-height:0pt;">&nbsp;</td></tr></table></td>
																								<td width="210" height="50" align="center" style="background:#ABC1DE; color:#F5F5F5;border-radius:7px;">
																									<a href="#" target="_blank" style="color:#ffffff; text-decoration:none; font-family:\'Roboto\', Arial, sans-serif; font-size:15px; width: 210px; height: 50px;line-height:50px; display: block; text-align: center;" ><img src="'.base_url().'assets/email/welcome/download.png" width="20" height="20" alt="" /> <span style="color:#ffffff; text-decoration:none; padding-left: 5px">Download the app</span></a>
																								</td>
																								<td bgcolor="#ffffff" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#F8F8F8"><tr><td bgcolor="#F8F8F8" height="25" style="font-size:0pt; line-height:0pt;">&nbsp;</td></tr></table></td>
																							</tr>
																						</table>
																			...
																			<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#ffffff" style="border-radius: 0 0 5px 5px ">
																				<tr>
																					<td width="100%" style="padding: 40px 0;">
																						<table width="100%" border="0" cellspacing="0" cellpadding="0">
																							<tr>
																								<td align="right" style="padding: 0 10px;"><a href="#"><img class="social-btn" src="'.base_url().'assets/email/google-play.png" width="148" height="44" border="0" alt="" /></a></td>
																								<td align="left" style="padding: 0 10px;"><a href="#"><img class="social-btn" src="'.base_url().'assets/email/apple-store.png" width="132" height="44" border="0" alt="" /></a></td>
																							</tr>
																						</table>
																					</td>
																				</tr>
