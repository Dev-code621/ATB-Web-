                    ...
                    <div class="full-height-content-body">
                        ...
                        <div class="portlet light">
                            <div class="portlet-title">
                                <div class="caption">
                                    <span class="caption-subject bold uppercase">Block User</span>
                                </div>

                            </div>
                            <div class="portlet-body">
                                <form class="newAdminForm" action="<?php echo route('admin.signups.submit_block');?>" method="get" enctype="multipart/form-data">
                                    ...
                                    <input type="hidden" id="block_userid" name="block_userid" value="<?php echo $block_userid;?>">
