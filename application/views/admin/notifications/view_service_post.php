    ...
    <main class="posts-page minPaddingTop bg-white">
        <div class="container">
            <header>
                ...
                <div class="user-info">
                    <div class="user-icon">
                        <img src="<?php echo $post['user'][0]['business_info']['business_logo'];?>" alt="User icon">
                    </div>
                    <div class="user-info-content">
                        <h2 class="user-name"><?php echo $post['user'][0]['business_info']['business_name'];?> </h2>
            ...
            <?php if ($post['is_active'] == 1) { ?>
                <a href="#" data-modal="blockModal" class="btn btn-outline-danger"><i class="fa-regular fa-ban"></i> Block this service</a>

            <?php } ?>
            <?php if ($post['is_active'] == 2) { ?>
                <a href="#" data-modal="unblockModal" class="btn btn-outline-danger"><i class="fa-solid fa-circle-check"></i> Unblock this service</a>

            <?php } ?>

            <?php if ($post['is_active'] == 3) { ?>
                <a href="#" data-modal="blockModal1" class="btn btn-outline-danger"><i class="fa-regular fa-ban"></i> Decline this service</a>
                <a href="#" data-modal="unblockModal1" class="btn btn-success"><i class="fa-solid fa-circle-check"></i> Approve this service</a>
            <?php } ?>   
            </header>
        </div>
        <div class="modal" id="blockModal">
                ...
                <div class="text-center">
                    ...
                    <h3>Are you sure you want to block this Service?</h3>
                    <h4>If so, please provide a reason below</h4>
                    <div id="screenHeight"></div>
                </div>
                <form 
                   action="<?php echo route('admin.notifications.block_service');?>" method="get" enctype="multipart/form-data"  method="get" enctype="multipart/form-data" >
                    ...
                    <button type="submit"  class="btn btn-outline-danger"><i class="fa-regular fa-ban"></i> Block this service</button>
            ...
            <div class="modal" id="unblockModal">
                ...
                <div class="text-center">
                    <div class="iconTitle"><i class="fa-solid fa-user-minus"></i></div>
                    <h3>Are you sure you want to unblock this service?</h3>
                    <h4>If so, please provide a reason below</h4>
                    <div id="screenHeight"></div>
                </div>
                <form 
                   action="<?php echo route('admin.notifications.unblock_service');?>" method="get" enctype="multipart/form-data" method="get" enctype="multipart/form-data" >
                    ...
                    <button type="submit"  class="btn btn-outline-danger"><i class="fa-solid fa-circle-check"></i> Unblock this service</button>
            ...
            <div class="modal" id="blockModal1">
                ...
                <div class="text-center">
                    <div class="iconTitle"><i class="fa-solid fa-user-minus"></i></div>
                    <h3>Are you sure you want to decline this Service?</h3>
                    <h4>If so, please provide a reason below</h4>
                    <div id="screenHeight"></div>
                </div>
                <form 
                   action="<?php echo route('admin.notifications.block_service');?>" method="get" enctype="multipart/form-data" action="<?php echo route('admin.business.submit_block');?>" method="get" enctype="multipart/form-data" >
                    <textarea rows="5" id="blockReason" name="blockReason"  placeholder="This business is providing spam, in all inboxes"></textarea>
                    <input type="hidden" id="block_postid" name="block_postid" value="<?php echo  $post['id'];?>">
                    <button type="submit"  class="btn btn-outline-danger"><i class="fa-regular fa-ban"></i> Decline this service</button>
            ...
            <div class="modal" id="unblockModal1">
                ...
                <div class="text-center">
                    <div class="iconTitle"><i class="fa-solid fa-user-minus"></i></div>
                    <h3>Are you sure you want to approve this service?</h3>
                    <h4>If so, please provide a reason below</h4>
                    <div id="screenHeight"></div>
                </div>
                <form 
                   action="<?php echo route('admin.notifications.unblock_service');?>" method="get" enctype="multipart/form-data" action="<?php echo route('admin.business.submit_block');?>" method="get" enctype="multipart/form-data" >
                    <textarea rows="5" id="unblockReason" name="unblockReason" placeholder="Please provide approved reason"></textarea>
                    <input type="hidden" id="unblock_postid" name="unblock_postid" value="<?php echo  $post['id'];?>">
                    <button type="submit"  class="btn btn-success"><i class="fa-solid fa-circle-check"></i> Approve this service</button>
        ...
        <div class="glide" id="sliderPosts">
            ...
            <section class="tabs-container posts-tab mt-30">
                <div class="navTabs position-relative">
                    <button class="btn tablinks active" data-tab="report-information">Service Information</button>
