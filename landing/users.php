...
<?php            
        ...
        if(array_key_exists('sendEmail',$_POST)){
           ...
           makeMail($_POST["firstname"],$_POST["surname"],$_POST["email"],$_POST["instagram"]);

        }                               
        function makeMail($firstname, $surname,$email, $instagram) {
          ...
          ';	
            sendEmail($firstname,$surname,$email,"Welcome to ATB",$emailboady,"This is anoter detail");
        }
    ?>